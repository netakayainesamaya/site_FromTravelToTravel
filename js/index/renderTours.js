...
async function getTours() {
    ...
    generalSort('#generalpricestop', toursArray, maxPriceSort);

    // запускаем функцию сортировки по цене от меньшего к большему
    generalSort('#generalpricesbottom', toursArray, minPriceSort);

    // запускаем функцию сортировки по продолжительности от большего к меньшему
    generalSort('#generalduringtop', toursArray, maxDuringSort);

    // запускаем функцию сортировки по продолжительности от меньшего к большему
    generalSort('#generalduringbottom', toursArray, minDuringSort);
    ...
    // скрываем лишние контейнеры при запуске
    firstPagePagination(); 
}
...
function renderTours(toursArray) {
    toursArray.forEach(function (item) {
        ...
        const toursHTML =  `<div class="preview__container"  data-days="${item.duringDays}">    
